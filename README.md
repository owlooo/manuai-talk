...
제품 매뉴얼에서 필요한 내용을 질문으로 찾아볼 수 있는 AI 상담 서비스입니다.

6인 팀에서 프런트엔드를 주로 맡고 백엔드 개발을 도왔습니다. 제품을 선택하고 질문한 뒤 답변을 읽거나 듣는 화면, 제품 관리와 QR·AR 연결이 제 담당이었습니다.
...
제품에 관해 질문하면 답변과 매뉴얼 이미지를 함께 보여줍니다.
**13초 채팅 미리보기**와 답변 화면입니다.

**[QR → 채팅 → AR 시연 영상 파일 · 50초](docs/media/service-demo.mp4)**

2025년 팀 최종 발표에서 사용한 시연입니다. 영상에는 제가 맡은 화면과 백엔드 연동뿐 아니라 팀에서 함께 만든 RAG 상담 기능도 포함돼 있습니다.
...
AR에서 선택한 제품의 상담으로 바로 이동할 수 있습니다.
</details>
...
재생 컴포넌트가 해제될 때는 WebSocket 연결과 오디오 리소스도 함께 정리하도록 했습니다.
...
기존 공개 데모는 2026.09.20 확인 당시 접속되지 않았습니다. 위 영상과 화면은 프로젝트 당시 시연 기록입니다.
